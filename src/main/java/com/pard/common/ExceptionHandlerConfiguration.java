...
import com.pard.common.exception.ExceptionHandler;
import com.pard.common.exception.ValidationException;
...
public class ExceptionHandlerConfiguration {
    ...
    public ExceptionHandler validationExceptionHandler() {
        ExceptionHandler handler = new ExceptionHandler() {
            ...
            @Override
            public ResponseMessage handle(Throwable e) {
                return ResponseMessage.error(String.valueOf(((ValidationException) e).getResults()), 400);
            }
        };
        return handler;
    }
