(function ($) {
    ...
    function switchAction(id, open) {
        ...
        if (open) {
            $(".select2-results__options li[val=" + id + "] span[class]:eq(0)").removeClass("glyphicons-chevron-right").addClass("glyphicon-chevron-down");
            $(".select2-results__options li[parent='" + id + "']").slideDown();
        } else {
            $(".select2-results__options li[val=" + id + "] span[class]:eq(0)").addClass("glyphicons-chevron-right").removeClass("glyphicons-chevron-down");
    ...
    function open() {
        setTimeout(function () {
            ...
            $(".select2-results__options li").each(function () {
                ...
                if ($this.attr("parent")) {
                    $(this).siblings("li[val=" + $this.attr("parent") + "]").find("span:eq(0)").addClass("glyphicons glyphicons-chevron-down switch").css({
                        "padding": "0 10px",
                        "cursor": "default"
                    });
                ...
                if (!$this.attr("style")) {
                    var paddingLeft = getLevel($this.attr("val")) * 2 - 1;
            ...
            $(".switch").mousedown(function () {
                switchAction($(this).parent().attr("val"), $(this).hasClass("glyphicons-chevron-right"));
