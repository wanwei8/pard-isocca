...
(function ($, undefined) {
    cmms = {
        ...
        init: function (initAnyway) {
            ...
            for (var func in cmms.functions) if (cmms.functions.hasOwnProperty(func)) {
                cmms.functions[func]();
            }
        }
    }

    cmms.functions.basics = function () {
    ...
    cmms.functions.enableSidebar = function () {
    ...
    cmms.functions.enableAjax = function () {
        ...
        //if(window.Pace) {
        cmms_ajax_options['loading_overlay'] = 'body';//the opaque overlay is applied to 'body'
        //}

        //initiate ajax loading on this element( which is .page-content-area[data-ajax-content=true] in Ace's demo)
        $('[data-ajax-content=true]').ace_ajax(cmms_ajax_options)
    ...
    cmms.functions.handleScrollbars = function () {
    ...
    cmms.functions.dropdownAutoPos = function () {
    ...
    cmms.functions.navbarHelpers = function () {
    ...
    cmms.functions.sidebarTooltips = function () {
    ...
    cmms.functions.someBrowserFix = function () {
    ...
    cmms.functions.bsCollapseToggle = function () {
    ...
    cmms.functions.smallDeviceDropdowns = function () {
